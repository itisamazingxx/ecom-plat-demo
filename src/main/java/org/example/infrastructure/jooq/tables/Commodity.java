...
public class Commodity extends TableImpl<CommodityRecord> {
    ...
    /**
     * The reference instance of <code>ecom-plat.commodity</code>
     */
    ...
    /**
     * The column <code>ecom-plat.commodity.commodity_id</code>.
     */
    ...
    /**
     * The column <code>ecom-plat.commodity.commodity_name</code>.
     */
    ...
    /**
     * The column <code>ecom-plat.commodity.description</code>.
     */
    ...
    /**
     * The column <code>ecom-plat.commodity.price</code>.
     */
    public final TableField<CommodityRecord, Integer> PRICE = createField(DSL.name("price"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>ecom-plat.commodity.img_url</code>.
     */
    public final TableField<CommodityRecord, String> IMG_URL = createField(DSL.name("img_url"), SQLDataType.VARCHAR(64), this, "");
    ...
    /**
     * Create an aliased <code>ecom-plat.commodity</code> table reference
     */
    ...
    /**
     * Create a <code>ecom-plat.commodity</code> table reference
     */
    public Commodity() {
